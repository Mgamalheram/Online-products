      ...
      <div class="grid grid-cols-12 gap-4">
        <div class="md:col-span-4 col-span-12">
          <Image
            ...
            preview
            imageClass="md:h-[225px] object-cover rounded-lg"
            class="md:h-[225px] object-cover border rounded-lg"
          />
        </div>
...
const items = ref([
  ...
  {
    label: t("NAV.products") + " " + route.query.category,
    url: "",
    // disabled: true,
  },
]);
...
const {
  ...
  $fetch(`/products/category/${route.query.category}`, {
    method: "GET",
    params: {
